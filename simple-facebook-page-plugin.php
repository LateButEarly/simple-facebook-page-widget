 ...
 */
define( 'SIMPLE_FACEBOOK_PAGE_VERSION', '1.6.0' );
if ( ! defined( 'SIMPLE_FACEBOOK_PAGE_LAST_VERSION' ) ) {
	define( 'SIMPLE_FACEBOOK_PAGE_LAST_VERSION', '1.5.0' );
}
